...
export default function LookbookStudio({ onQuickView }: LookbookStudioProps) {
  ...
  const lookbookData: LookbookItem[] = [
      ...
      pins: [
        {
          ...
          x: 48,
          y: 35,
          label: 'Spider Emblem Fitted Crop Top',
          productId: 'w-107',
        },
        {
          id: 'pin-1-bottom',
    ...
    },
    {
      ...
      subtitle: 'Spider-Man Graphic Heavyweight Oversized Tee.',
      image: '/products/spiderman-oversized-tee-men.jpg',
      pins: [
        {
          id: 'pin-2-top',
          x: 45,
          y: 38,
          label: 'Spider-Man Graphic Oversized Tee',
          productId: 'm-201',
        },
      ],
    },
